	...
	return (
		<footer className="footer-container">
			<div className="col-md-8 d-flex">
				<a
					href="https://github.com/wilbura009/streaming_service_sorter"
					class="mb-3 me-2 mb-md-0 text-muted text-decoration-none"
				>
					<svg
			...
			>
				<a class="btn btn-primary" href="#top" style={{backgroundColor: "#9198e5", borderColor:"#fff"}}>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="16"
						height="16"
